...
public class WheelButtonLightResponse
{
    ...
    /// <summary>常亮时LED灯颜色R分量 (0-255)</summary>
    public byte ColorR { get; set; }

    /// <summary>常亮时LED灯颜色G分量 (0-255)</summary>
    public byte ColorG { get; set; }

    /// <summary>常亮时LED灯颜色B分量 (0-255)</summary>
    ...
    /// <summary>按键灯遥测显示颜色R分量 (0-255)</summary>
    public byte TelemetryColorR { get; set; }

    /// <summary>按键灯遥测显示颜色G分量 (0-255)</summary>
    public byte TelemetryColorG { get; set; }

    /// <summary>按键灯遥测显示颜色B分量 (0-255)</summary>
